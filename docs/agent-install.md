# zaloclaw — Hướng dẫn cài đặt & sử dụng cho Agent

> Tài liệu chi tiết dành cho AI agent và người dùng: cách cài đặt plugin, cấu hình từng tính năng, và sử dụng toàn bộ 147 công cụ (actions) của zaloclaw.
...
Truy cập OpenClaw Control Panel → Channels → zaloclaw → Login. QR code hiện trên giao diện web.

### Credentials

Sau khi đăng nhập thành công:
- Credentials lưu tại `~/.openclaw/zaloclaw-credentials.json`
...
Plugin cung cấp **1 tool duy nhất** tên `zaloclaw` với 147 actions. Agent chọn action bằng tên.
